...
function contactProfessor(classId, assignmentTitle) {
  ...
  alert(`📧 Contact Professor\n\nClass: ${classItem.name}\nAssignment: ${assignmentTitle}\n\nPlease email your professor at: ${classItem.professor_name || 'your professor'}`);
}
...
function initializeCalendar() {
  ...
  function renderCalendar() {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      // ✅ REMOVED: Deadline event checking
      // Calendar will now only show dates without assignment markers
  ...
  function showEventsForDate(year, month, day) {
    ...
    // ✅ REMOVED: Assignment deadline display
    // Show simple message instead of assignment deadlines
    eventList.innerHTML = '<li>No scheduled events for this day</li>';
  }
